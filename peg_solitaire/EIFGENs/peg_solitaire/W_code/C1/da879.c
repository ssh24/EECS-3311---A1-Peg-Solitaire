...
extern EIF_TYPED_VALUE F879_7159(EIF_REFERENCE);
extern EIF_TYPED_VALUE F879_7160(EIF_REFERENCE);
extern EIF_TYPED_VALUE F879_7161(EIF_REFERENCE);
...
EIF_TYPED_VALUE F879_7159 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F879_7160 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F879_7161 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 878, Current, 0, 0, 12780);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5033, "fractional_second", tr1));
