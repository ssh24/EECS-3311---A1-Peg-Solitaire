...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 918, Current, 0, 2, 13033);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(918, Current, 13033);
	RTIV(Current, RTAL);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 918, Current, 0, 3, 13034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(918, Current, 13034);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 918, Current, 0, 1, 13035);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(918, Current, 13035);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 918, Current, 0, 2, 13036);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(918, Current, 13036);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 918, Current, 0, 3, 13039);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F919_3559 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 918, Current, 0, 0, 13041);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 918, Current, 3, 3, 13043);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(918, Current, 13043);
	RTCC(arg1, 918, l_feature_name, 1, RTWCT(1700, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
