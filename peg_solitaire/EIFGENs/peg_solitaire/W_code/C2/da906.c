...
extern void F906_7451(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F906_7452(EIF_REFERENCE);
extern EIF_TYPED_VALUE F906_7453(EIF_REFERENCE);
extern void F906_7454(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F906_7455(EIF_REFERENCE);
extern EIF_TYPED_VALUE F906_7456(EIF_REFERENCE);
extern EIF_TYPED_VALUE F906_7457(EIF_REFERENCE);
extern EIF_TYPED_VALUE F906_7458(EIF_REFERENCE);
...
/* {DATE_TIME_CODE}.make */
void F906_7451 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 905, Current, 0, 1, 13097);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(905, Current, 13097);
...
body:;
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5291, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 905, Current, 0, 0, 13098);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(905, Current, 13098);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F906_7453 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 905, Current, 0, 0, 13099);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(905, Current, 13099);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5298, Dtype(Current)));
	switch (ti4_1) {
		case 18L:
		case 19L:
		case 20L:
...
void F906_7454 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 905, Current, 1, 1, 13100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(905, Current, 13100);
	RTCC(arg1, 905, l_feature_name, 1, eif_attached_type(219));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5292, 0xF80000DB, 0); /* value */
	...
	*(EIF_REFERENCE *)(Current + RTWA(5292, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	if (tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 5293, 0x10000000, 1); /* count_max */
		
		*(EIF_INTEGER_32 *)(Current + RTWA(5293, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5294, 0x10000000, 1); /* count_min */
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(5294, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		...
		RTHOOK(8);
		RTDBGAA(Current, dtype, 5296, 0x10000000, 1); /* value_max */
		
		*(EIF_INTEGER_32 *)(Current + RTWA(5296, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 31L);
		RTHOOK(9);
		RTDBGAA(Current, dtype, 5297, 0x10000000, 1); /* value_min */
		
		*(EIF_INTEGER_32 *)(Current + RTWA(5297, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5299, 0x04000000, 1); /* is_text */
		
		*(EIF_BOOLEAN *)(Current + RTWA(5299, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
		RTHOOK(11);
		RTDBGAA(Current, dtype, 5300, 0x04000000, 1); /* is_numeric */
		
		*(EIF_BOOLEAN *)(Current + RTWA(5300, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(12);
		RTDBGAA(Current, dtype, 5298, 0x10000000, 1); /* type */
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(5298, dtype)) = (EIF_INTEGER_32) ti4_1;
		...
		if (tb1) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(5294, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
			RTHOOK(16);
			RTDBGAL(Current, 1, 0xF80000DB, 0, 0); /* loc1 */
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(5298, dtype)) = (EIF_INTEGER_32) ti4_1;
			...
			if (tb1) {
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(5293, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				RTHOOK(24);
				RTDBGAA(Current, dtype, 5294, 0x10000000, 1); /* count_min */
				
				*(EIF_INTEGER_32 *)(Current + RTWA(5294, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				RTHOOK(25);
				RTDBGAL(Current, 1, 0xF80000DB, 0, 0); /* loc1 */
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(5296, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 7L);
				RTHOOK(27);
				RTDBGAA(Current, dtype, 5297, 0x10000000, 1); /* value_min */
				...
				*(EIF_BOOLEAN *)(Current + RTWA(5300, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
				RTHOOK(30);
				RTDBGAA(Current, dtype, 5298, 0x10000000, 1); /* type */
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(5298, dtype)) = (EIF_INTEGER_32) ti4_1;
				...
				if (tb1) {
					...
					*(EIF_INTEGER_32 *)(Current + RTWA(5293, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
					RTHOOK(33);
					RTDBGAA(Current, dtype, 5294, 0x10000000, 1); /* count_min */
					
					*(EIF_INTEGER_32 *)(Current + RTWA(5294, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
					RTHOOK(34);
					RTDBGAL(Current, 1, 0xF80000DB, 0, 0); /* loc1 */
					...
					*(EIF_INTEGER_32 *)(Current + RTWA(5296, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
					RTHOOK(39);
					RTDBGAA(Current, dtype, 5297, 0x10000000, 1); /* value_min */
								...
								if (tb1) {
									...
									*(EIF_INTEGER_32 *)(Current + RTWA(5298, dtype)) = (EIF_INTEGER_32) ti4_1;
									...
									if (tb1) {
										...
										*(EIF_INTEGER_32 *)(Current + RTWA(5296, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 24L);
										RTHOOK(81);
										RTDBGAA(Current, dtype, 5297, 0x10000000, 1); /* value_min */
											...
											if (tb1) {
												...
												*(EIF_INTEGER_32 *)(Current + RTWA(5298, dtype)) = (EIF_INTEGER_32) ti4_1;
												...
												if (tb1) {
													...
													*(EIF_INTEGER_32 *)(Current + RTWA(5296, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 59L);
													RTHOOK(108);
													RTDBGAA(Current, dtype, 5297, 0x10000000, 1); /* value_min */
	...
	RTHOOK(206);
	RTDBGAA(Current, dtype, 5295, 0xF80000DB, 0); /* name */
	
	RTAR(Current, loc1);
	*(EIF_REFERENCE *)(Current + RTWA(5295, dtype)) = (EIF_REFERENCE) RTCCL(loc1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(207);
		RTCT("value_set", EX_POST);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5292, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F906_7455 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {DATE_TIME_CODE}.name */
EIF_TYPED_VALUE F906_7458 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
